...
export default function Portfolio() {
  return (
    <>
      <section class="portfolio pt-80 pb-80">
        <div class="container">
          <div class="row center wow fadeInDown">
            <div class="ca ca-heading-center">
              <h2>Our Recent Projects</h2>
            </div>
            <div class="col-sm-6 col-sm-offset-3 blurb pb-30">
        ...
        <div class="controls center">
          ...
          <li class="control" data-filter=".branding">
            Branding
          </li>
          <li class="control" data-filter=".design">
            Design
          </li>
          <li class="control" data-filter=".life">
            Lifestyle
          </li>
        </div>
